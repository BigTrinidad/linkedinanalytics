...
describe "LinkedInAnalytics::AccessToken" do
  ...
  context "When everything is set" do
    subject {LinkedInAnalytics::AccessToken.new(tok, expires_in, expires_at)}
